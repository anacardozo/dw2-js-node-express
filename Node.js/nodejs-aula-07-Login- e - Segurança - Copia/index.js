...
//Configurando o Express Session (gerando um segredo para a sessão do site
app.use(
  session({
    secret: "minhalojasecret",
    cookie: { maxAge: 3600000 }, //sessão expira em uma hora -> tempo que a sessão dura
    saveUninitialized: false,
    resave: false, //não reescreve a sessão
  })
);
